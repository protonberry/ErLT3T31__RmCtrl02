...
static volatile int Bcode = 0;           // 10s digit is button, 1s is function
static volatile bool Tareflag = false;   // true is tare, false do nothing
static volatile bool TorMaxflag = false; // true is Max torque stop test
static volatile bool TestinProgress = false;
static volatile int EditFieldsFlag = 0;
static volatile int NumRDtoAvg = 3;
static volatile float Wtgm = 0.;
static volatile float MaxSx = 0.;
static volatile float rotAtMax = 0.;
static volatile float PrevWtgm = 0.;
static volatile int TareCnt = 20;
static volatile double StepCounter = 0;
static volatile double MaxStepCounter = 0;
static volatile int PressCnt = 0;
static volatile int TestStage = 1;
